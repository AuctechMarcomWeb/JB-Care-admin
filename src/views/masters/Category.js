...
const Category = () => {
  ...
  const [stockData] = useState([
    { id: 1, categoryName: 'Electric' },
    { id: 2, categoryName: 'Plumbing' },
    { id: 3, categoryName: 'Hardware' },
    { id: 4, categoryName: 'Electronics' },
    { id: 5, categoryName: 'Electrical' },
    { id: 6, categoryName: 'Tools' },
    { id: 7, categoryName: 'Plumbing' },
    ...
    <div className="bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Category Master</h2>
            <p className="text-gray-600 mt-1">Manage Category Master</p>
          </div>
