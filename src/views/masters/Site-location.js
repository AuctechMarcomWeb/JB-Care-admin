...
const SiteLocation = () => {
  const [stockData] = useState([
    { id: 1, LocationName: 'Furfurinagar' },
    { id: 2, LocationName: 'Chatori Gali' },
    { id: 3, LocationName: 'Toofanpur' },
    { id: 4, LocationName: 'Gorakhpur' },
    { id: 5, LocationName: 'Devpuram' },
    { id: 6, LocationName: 'Dholakpur' },
  ...
  const submitAdd = () => {
    if (formData.LocationName) {
      const newProduct = { id: Date.now(), LocationName: formData.LocationName }
  ...
  const handleEditProduct = (item) => {
    ...
    setFormData({ LocationName: item.LocationName })
          ...
          <div className="bg-white p-6 max-w-md w-full max-h-[90vh] overflow-y-auto rounded shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {showAddModal ? 'Add New Site-Location' : 'Edit Site-Location'}
                </h3>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 mt-6">
              ...
              >
                ...
                {showAddModal ? 'Add Site-Location' : 'Update Site-Location'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 max-w-md w-full rounded shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              {selectedItem && (
                <>
                  Are you sure you want to delete <strong>{selectedItem.LocationName}</strong>? This
