...
const Project = () => {
  ...
  useEffect(() => {
    setLoading(true)
    getRequest(
      `projects?search=${searchTerm}&page=${page}&limit=${limit}&fromDate=${fromDate}&toDate=${toDate}${
      ...
      .then((res) => {
        ...
        setTotal(responseData?.totalProjects || 0)
      })
  ...
  return (
    <div className="bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 overflow-x-auto">
        <div className="flex flex-wrap items-end gap-4 min-w-max">
          {/* From Date */}
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-700 mb-1">Filter by Site</label>
            <select
              value={selectedSite}
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-56 border border-gray-300 focus:ring-2 focus:ring-blue-500 rounded-md"
              />
            </div>
          </div>
