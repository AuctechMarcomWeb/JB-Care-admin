...
const Rental = () => {
  const [stockData] = useState([
    { id: 1, rentalName: 'Rental 1', projectName: 'Project A', landlordName: 'John Doe' },
    { id: 2, rentalName: 'Rental 2', projectName: 'Project B', landlordName: 'Jane Smith' },
    { id: 3, rentalName: 'Rental 3', projectName: 'Project C', landlordName: 'Mike Johnson' },
  ])
  ...
  const submitAdd = () => {
    if (formData.rentalName && formData.projectName && formData.landlordName) {
      const newRental = { id: Date.now(), ...formData }
      setStock((prev) => [...prev, newRental])
    ...
    <div className="bg-white">
          ...
          <div className="bg-white p-6 max-w-md w-full max-h-[90vh] overflow-y-auto rounded shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {showAddModal ? 'Add Rental' : 'Edit Rental'}
                </h3>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 mt-6">
              ...
              >
                ...
                {showAddModal ? 'Add Rental' : 'Update Rental'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 max-w-md w-full rounded shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              {selectedItem && (
                <>
                  Are you sure you want to delete <strong>{selectedItem.rentalName}</strong>?
                </>
              )}
            </p>
      ...
      <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <ExportButton data={stock} fileName="RentalData.xlsx" sheetName="Rental" />
            <button
      ...
      <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
        <div className="relative max-w-md">
          ...
          <input
            type="text"
            placeholder="Search by rental, project or landlord..."
            value={searchTerm}
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {paginatedData.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">{item.rentalName}</td>
      ...
      {/* Pagination */}
      <div className="px-4 sm:px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0">
        ...
        <div className="flex items-center space-x-1 flex-wrap gap-1">
          <button
            ...
            className="px-3 py-1 border border-gray-300 text-sm rounded flex items-center disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50"
          >
