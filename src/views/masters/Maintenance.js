...
const Maintenance = () => {
  ...
  const [stockData] = useState([
    { id: 1, aqureFit: '1000', perDayCharges: '100' },
    { id: 2, aqureFit: '500', perDayCharges: '50' },
    { id: 3, aqureFit: '3000', perDayCharges: '300' },
    { id: 4, aqureFit: '800', perDayCharges: '80' },
    { id: 5, aqureFit: '1200', perDayCharges: '120' },
    { id: 6, aqureFit: '1800', perDayCharges: '180' },
    { id: 7, aqureFit: '2000', perDayCharges: '200' },
    { id: 8, aqureFit: '1000', perDayCharges: '100' },
  ])
    ...
    <div className="bg-white">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {showAddModal ? 'Add New Maintenance' : 'Edit Maintenance'}
                </h3>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Per Day Charges(₹) *</label>
                <input
                  type="text"
                  name="perDayCharges"
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              >
                ...
                {showAddModal ? 'Add Maintenance' : 'Update Maintenance'}
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Maintenance Master</h2>
            <p className="text-gray-600 mt-1">Manage Maintenance Master</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by Maintenance name..."
                value={searchTerm}
          ...
          <thead>
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                <div className="flex items-center"> Square feet</div>
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                <div className="flex items-center"> Per Day Charges</div>
              </th>
            ...
            {paginatedData.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <span className="text-sm font-medium text-gray-900">{item?.aqureFit} sq ft</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
